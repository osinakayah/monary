...
import styles from './Styles/SellStockStyle'
    ...
    return (
      <View style={styles.container}>
        <Form>
          <Item picker fixedLabel>
            ...
            >
              ...
              <Picker.Item label="Stop Loss" value="key2" />
            </Picker>
          </Item>
          <Item fixedLabel>
        ...
        <Grid style={{marginTop: 12}}>
          <Row>
            <Col>
              <Button block style={{backgroundColor: Colors.colorGain, marginRight: 3 }}><Text style={{color: Colors.silver}} >Sell</Text></Button>
            </Col>
            <Col>
